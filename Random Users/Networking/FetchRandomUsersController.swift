...
class FetchRandomUsersController {
    ...
    func fetchRandomUsers(numberOfUsers: Int = 1000, using session: URLSession = URLSession.shared,
        ...
        fetch(from: url, using: session) { (dictionary: RandomUsersResults?, error: Error?) in
