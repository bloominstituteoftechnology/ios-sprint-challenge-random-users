...
class ContactsTableViewController: UITableViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if segue.identifier == "DetailSegue" {
            ...
            guard let destVC = segue.destination as? ContactDetailViewController else {return}
            
            guard let users = users?.users, let indexPath = tableView.indexPath(for: sender as! ContactTableViewCell) else {return}
