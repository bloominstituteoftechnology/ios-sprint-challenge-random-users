...
extension Result: Decodable {
    ...
    init(from decoder: Decoder) throws {
        ...
        //
        //        phone = try friendContainer.decode(String.self, forKey: .phone)
        //        email = try friendContainer.decode(String.self, forKey: .email)
        //
        ...
        //
        //        large = try photosContainer.decode(URL.self, forKey: .large)
        //        thumbnail = try photosContainer.decode(URL.self, forKey: .thumbnail)
